...
// Auto-converted from 24Plastform Admin resetPassword.jsx by convert_jsx_to_tsx.py.
...
export default function KaoriPlatformShell() {
  const [activeRoute, setActiveRoute] = useState('admin-reset-password'); // Set default to Admin Reset Password flow for demo
