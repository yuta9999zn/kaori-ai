...
// Auto-converted from 9Layout wrapper.jsx by convert_jsx_to_tsx.py.
  ...
  return (
    <PageContainer maxWidth="default">
      <PageHeader 
        ...
        subtitle="Monitor system health, usage, and recent activity."
      />
      <Section>
  ...
  return (
    <PageContainer maxWidth="narrow">
      <PageHeader 
        ...
        subtitle="Manage devices where your account is currently signed in."
      />
        ...
        <div className="flex-1 flex flex-col min-w-0 h-full overflow-hidden relative">
          ...
          <main className="flex-1 overflow-y-auto p-6 bg-[var(--bg-app)]">
            {activeRoute === 'overview' ? (
              ...
              <PageContainer maxWidth="narrow">
                <PageHeader 
                  title={`${NAVIGATION_CONFIG.flatMap(g => g.items).find(n => n.id === activeRoute)?.label} module`}
                  subtitle="This section of the platform is currently being designed."
                />
                <Section>
                  <div className="flex flex-col items-center justify-center py-20 px-4 text-center border border-dashed border-[var(--border-color)] rounded-lg-custom bg-[var(--bg-card)]/50 mx-auto w-full animate-in fade-in duration-300">
                    ...
                    <p className="text-sm text-[var(--text-secondary)] max-w-sm">
                      Content for {activeRoute} will populate here inside the Shell Wrapper.
                    </p>
                  </div>
                </Section>
              </PageContainer>
