...
|---|---|---|
| PostgreSQL 15 + pgvector | ✅ chạy | RLS multi-tenancy cutover (ADR-0013); 134 mig files (max 137) tại 2026-06-06 (EU AI Act 134-137; 137 = K-25 ai_model_card) |
